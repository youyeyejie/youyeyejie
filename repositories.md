...
- [SJTU Course repositories](#sjtu-course-repositories)
    ...
    - [NIS2333 信息安全数学基础Ⅰ](#nis2333-信息安全数学基础Ⅰ)
    ...
    - [NIS3366 项目管理与软件设计](#nis3366-项目管理与软件设计)
    - [NIS3368 安全模型开发及安全编程](#nis3368-安全模型开发及安全编程)
    - [NIS4307 人工智能导论](#nis4307-人工智能导论)
    - [NIS4335 信息安全综合实践Ⅱ](#nis4335-信息安全综合实践ⅱ)
    - [PHY 大学物理](#phy-大学物理)
- [Tool repositories](#tool-repositories)
...
- [Project repositories](#project-repositories)
    ...
    - [Gear Damage Analyse](#gear-damage-analyse)
    - [Humanity Last Exam](#humanity-last-exam)
    - [Tab-MIA](#tab-mia)
    - [SAMA-MIA](#sama-mia)
    - [WBC-MIA](#wbc-mia)
...
### NIS2333 信息安全数学基础Ⅰ
> Course repository for NIS2333 信息安全数学基础Ⅰ (Mathematical Foundations of Information Security (1)) at Shanghai Jiao Tong University.
...
### NIS3329 信息安全数学基础Ⅱ
> Course repository for NIS3329 信息安全数学基础Ⅱ (Mathematical Foundations of Information Security (2)) at Shanghai Jiao Tong University.
- **Link**: [NIS3329_2025-2026-2](https://github.com/youyeyejie/NIS3329_2025-2026-2)
- **Tags**:
    - Notes
    - Markdown
...
### NIS3352 现代密码学Ⅱ
> Course repository for NIS3352 现代密码学Ⅱ (Modern Cryptography II) at Shanghai Jiao Tong University.
- **Link**: [NIS3352_2025-2026-2](https://github.com/youyeyejie/NIS3352_2025-2026-2)
- **Tags**:
    - Notes
    - Markdown
...
- **Link**: [NIS3363_2025-2026-2](https://github.com/youyeyejie/NIS3363_2025-2026-2)
- **Tags**:
    - Notes
    - Markdown
    - Python
...
### NIS3365 现代密码学Ⅰ
> Course repository for NIS3365 现代密码学Ⅰ (Modern Cryptography I) at Shanghai Jiao Tong University.
...
### NIS4335 信息安全综合实践Ⅱ
> Course repository for NIS4335 信息安全综合实践Ⅱ (Information Security Comprehensive Practice II) at Shanghai Jiao Tong University.
- **Link**: [NIS4335_2025-2026-1](https://github.com/youyeyejie/NIS4335_2025-2026-1)
- **Tags**:
    - Assignments
    - CTF
...
- **Link**:
    - [IndySCC25_ECE](https://github.com/youyeyejie/IndySCC25_ECE)
    - [ExaGeoStatCPP](https://github.com/youyeyejie/ExaGeoStatCPP)
- **Tags**:
    - C++
    - report

### Gear Damage Analyse
> A repository for gear damage analysis in Challenge Cup.
- **Link**: [Gear-Damage-Analyse](https://github.com/youyeyejie/Gear-Damage-Analyse)
- **Tags**:
    - React
    - TypeScript

### Humanity Last Exam
> A reproduction and adaptation for Humanity Last Exam on SJTU deepseek.
- **Link**: [HLE_on_SJTU_deepseek](https://github.com/youyeyejie/HLE_on_SJTU_deepseek)
- **Tags**:
    - Python

### Tab-MIA
> A reproduction of "Tab-MIA: A Benchmark Dataset for Membership Inference Attacks on Tabular Data in LLMs"
- **Link**: [Tab-MIA](https://github.com/youyeyejie/Tab-MIA)
- **Tags**:
    - Python
    - MIA

### SAMA-MIA
> A reproduction of "Membership Inference Attacks Against Fine-tuned Diffusion Language Models"
- **Link**: [SAMA-MIA](https://github.com/youyeyejie/SAMA-MIA)
- **Tags**:
    - Python
    - MIA

### WBC-MIA
> A reproduction of "Window-based Membership Inference Attacks Against Fine-tuned Large Language Models"
- **Link**: [WBC-MIA](https://github.com/youyeyejie/WBC-MIA)
- **Tags**:
    - Python
    - MIA
...
- **Link**: [MyConfig](https://github.com/youyeyejie/config_repo)
- **Tags**:
    - Config
    - Dotfiles
